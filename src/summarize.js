...
const shorten = (s, max = 200) => (s.length > max ? s.slice(0, max).replace(/\s\S*$/, '') + '…' : s);

// NØGLEPUNKTER (array af korte uddrag) — kernen i v5. Hvert punkt er EKSISTERENDE tekst (evt. afkortet).
export function keyPoints(text, n = 4) {
